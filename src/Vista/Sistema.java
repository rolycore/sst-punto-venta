...
public final class Sistema extends javax.swing.JFrame {
    ...
    public void ListarCliente() {
        ...
        for (int i = 0; i < ListarCl.size(); i++) {
            ...
            ob[3] = ListarCl.get(i).getDireccioncliente();
            ob[4] = ListarCl.get(i).getCorreocliente();
            ob[5] = ListarCl.get(i).getNumerotelefono();
            modelo.addRow(ob);
        }
    ...
    public void ListarVentas() {
        ...
        for (int i = 0; i < ListarVenta.size(); i++) {
            ...
            ob[4] = ListarVenta.get(i).getObservaciones();
            ob[5] = ListarVenta.get(i).getFecha();
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/LOGOSHALOM.jpg"))); // NOI18N
        ...
        LabelVendedor.setText("Soluciones de software para tu empresa.");
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                    .addComponent(btnNuevaVenta, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 202, Short.MAX_VALUE)
        ...
        getContentPane().add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 0, 870, 160));
        ...
        TableVenta.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DESCRIPCIÓN", "CANTIDAD", "PRECIO U.", "PRECIO TOTAL", "OBSERVACIONES"
            }
        ));
        ...
        jLabel9.setText("Factura a Nombre de:");
        ...
        LabelTotal.setText("-----");
        jPanel2.add(LabelTotal, new org.netbeans.lib.awtextra.AbsoluteConstraints(720, 380, -1, -1));
        ...
        jPanel2.add(jLabel46, new org.netbeans.lib.awtextra.AbsoluteConstraints(280, 120, -1, -1));
        jPanel2.add(txtobserv, new org.netbeans.lib.awtextra.AbsoluteConstraints(380, 110, 210, 30));
        ...
        TableCliente.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "DNI/RUC", "NOMBRE", "DIRECCIÓN", "CORREO", "TELÉFONO"
            }
        ));
        ...
        jPanel9.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Registro Cliente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Segoe UI", 0, 12), new java.awt.Color(0, 0, 0))); // NOI18N
        ...
        btnExportar.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/excel.png"))); // NOI18N
        btnExportar.setText("jButton3");
        btnExportar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnExportarActionPerformed(evt);
            }
        });
        jPanel6.add(btnExportar, new org.netbeans.lib.awtextra.AbsoluteConstraints(100, 40, 30, 30));
        ...
        jPanel6.add(txtIdVenta, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 50, 46, -1));
        ...
        jPanel6.add(jLabel49, new org.netbeans.lib.awtextra.AbsoluteConstraints(140, 30, -1, -1));
        ...
        TableVentas.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID", "CLIENTE", "VENDEDOR", "TOTAL", "OBSERVACION", "FECHA", "ESTADO"
            }
        ));
            ...
            .addGroup(jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(txtCorreoConfig, javax.swing.GroupLayout.PREFERRED_SIZE, 250, javax.swing.GroupLayout.PREFERRED_SIZE))
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel8Layout.createSequentialGroup()
                ...
                .addGroup(jPanel8Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel8Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(jLabel31))
                    .addComponent(txtCorreoConfig, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(13, 13, 13)
        ...
        jPanel7.add(jPanel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(10, 70, 420, 330));
        ...
        jLabel33.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Img/iniciar-removebg-preview.png"))); // NOI18N
        ...
        jLabel38.setText("Desarrollado por: Rolando Salinas");
    ...
    private void btnPdfVentasActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPdfVentasActionPerformed
        if (txtIdVenta.getText().equals("")) {
            ...
            Vdao.pdfV(v.getId(), v.getCliente(), v.getTotal(), v.getFecha(), v.getVendedor(), v.getObservaciones());
        }
    ...
    private void btnEditarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnEditarClienteActionPerformed
        ...
        if ("".equals(txtIdCliente.getText())) {
            ...
            if (!"".equals(txtDniCliente.getText()) || !"".equals(txtNombreCliente.getText())) {
                ...
                cl.setCorreocliente(txtCorreoCliente.getText());
                cl.setDireccioncliente(txtDirecionCliente.getText());
                cl.setNumerotelefono(txtTelefonoCliente.getText());
    ...
    private void btnGuardarClienteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarClienteActionPerformed
        // TODO add your handling code here:
        // TODO add your handling code here:
        if (!"".equals(txtDniCliente.getText()) || !"".equals(txtNombreCliente.getText()) || !"".equals(txtDirecionCliente.getText()) || !"".equals(txtCorreo.getText()) || !"".equals(txtTelefonoCliente.getText())) {
            cl.setDni(txtDniCliente.getText());
            cl.setNombre(txtNombreCliente.getText());
            cl.setDireccioncliente(txtDirecionCliente.getText());
            cl.setCorreocliente(txtCorreoCliente.getText());
    ...
    private void txtRucVentaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtRucVentaKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!"".equals(txtRucVenta.getText())) {
                String ced = txtRucVenta.getText();
                cl = client.Buscarcliente(ced);
    ...
    private void txtCantidadVentaKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCantidadVentaKeyPressed
        ...
        if (evt.getKeyCode() == KeyEvent.VK_ENTER) {
            if (!"".equals(txtCantidadVenta.getText())) {
                ...
                String observa = txtobserv.getText();
    ...
    private void btnExportarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnExportarActionPerformed
        ...
        if (selecArchivo.showDialog(null, "Exportar") == JFileChooser.APPROVE_OPTION) {
            ...
            if (archivo.getName().endsWith("xls") || archivo.getName().endsWith("xlsx")) {
                JOptionPane.showMessageDialog(null, modeloE.Exportar(archivo, TableVentas) + "\n Formato ." + archivo.getName().substring(archivo.getName().lastIndexOf(".") + 1));
            } else {
    ...
    private void RegistrarVenta() {
        ...
        String observacion = txtobserv.getText();
        double monto = Totalpagar;
        v.setCliente(cliente);
        v.setVendedor(vendedor);
        v.setTotal(monto);
        v.setFecha(fechaActual);
        v.setObservaciones(observacion);
        v.setEstado("Facturado");
    ...
    private void RegistrarDetalle() {
        try {
            ...
            for (int i = 0; i < TableVenta.getRowCount(); i++) {
                ...
                System.out.println("Detalles a registrar - ID Producto: " + id_pro + ", Cantidad: " + cant + ", Precio: " + precio);
            ...
            int cliente = Integer.parseInt(txtIdCV.getText());
            System.out.println("ID del cliente: " + cliente);

            Vdao.pdfV(id, cliente, Totalpagar, LabelVendedor.getText(), fechaActual, txtobserv.getText());
            System.out.println("Generación de PDF completada");

        } catch (Exception e) {
            System.out.println("Error al registrar detalles o generar PDF: " + e.getMessage());
            e.printStackTrace();
        }
    }
